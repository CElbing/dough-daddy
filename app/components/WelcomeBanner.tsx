    ...
    return (
        <div className="flex justify-center mt-80">
            <div id="welcome-banner-container" className="text-center w-6/12">
                ...
                <p className="p-8 mx-[10%]"><i>"I have been crucified with Christ and I no longer live, but Christ lives in me.
                    The life I live in the body, I live by faith in the Son of God, who loved me and gave himself for me."</i></p>
